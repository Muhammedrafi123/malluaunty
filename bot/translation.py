...
class Translation(object):
    ...
    START_TEXT = """<b>Hey {} എന്തൊക്കെ ഇണ്ട് !!</b>
<i>Am Just A Advance Auto Filter Bot....😉

ഞാൻ @Movies_World_Hd_Grp ഗ്രൂപ്പ് cinema കൊടുക്കുന്ന bot ആണ് എന്നെ ഉണ്ടാക്കിയത് ഇദ്ദേഹം ആണ് @Botsvillage
Just add to me your group and chanels And Connect Them And See My Pevers
For More Details Click Help Button Below..
@Mallusbotsupport  @Movies_World_Hd_Grp  @minnaltv
</i>"""    
...
<b>➥ Source Code</b> : <i><a href="https://github.com/Muhammedrafi123/malluaunty">Click Me</a></i>
"""
